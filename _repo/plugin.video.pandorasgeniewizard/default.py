...
ADDONS         =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.pandorasgeniewizard'))
text_file_path = ADDONS + '/resources/'
USER_AGENT = 'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-GB; rv:1.9.0.3) Gecko/2008092417 Firefox/3.0.3'
base='Pandoras Genie wizard'
ADDON=xbmcaddon.Addon(id='plugin.video.pandorasgeniewizard')
Dialog = xbmcgui.Dialog()


VERSION = "1.0.0"
PATH = 'pandorasgeniewizard'
